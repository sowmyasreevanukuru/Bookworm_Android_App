...
public class customAdapter_userfav extends BaseAdapter {
    ...
    public customAdapter_userfav(Context context, ArrayList<Book> results) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        customAdapter_userfav.ViewHolder holder;

        if (convertView == null) {

            LayoutInflater inflater = LayoutInflater.from(mContext);
            convertView = inflater.inflate(R.layout.bookitem_fav, parent, false);
            holder = new customAdapter_userfav.ViewHolder();
            ...
            holder.img_fav=(ImageButton)convertView.findViewById(R.id.remove_fav);
            result = convertView;
            convertView.setTag(holder);
        } else {
            holder = (customAdapter_userfav.ViewHolder) convertView.getTag();
            result = convertView;
        }
